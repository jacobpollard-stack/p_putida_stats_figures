...
<ul>
  ...
  <li>Tests included Shapiro-Wilk for normality, ANOVA, Levene's test for variance homogeneity, and Scheirer–Ray–Hare non-parametric tests with Dunn's post-hoc corrections</li>
</ul>
...
<ul>
  ...
  <li>Fisher, R.A. (1925). <em>Statistical Methods for Research Workers</em>. Edinburgh: Oliver and Boyd.</li>
  ...
  <li>Tukey, J.W. (1949). <em>Comparing individual means in the analysis of variance</em>. Biometrics, 5(2), pp. 99–114.</li>
